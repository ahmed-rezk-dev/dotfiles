...
- Answer is in `/Users/ahmed.rezk/.config/opencode/context/` (use ContextScout instead)
...
- **External Context Management**: `/Users/ahmed.rezk/.config/opencode/context/core/workflows/external-context-management.md`
- **Task Delegation**: `/Users/ahmed.rezk/.config/opencode/context/core/workflows/task-delegation-basics.md`
