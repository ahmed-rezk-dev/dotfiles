...
**Rule**: If it's not in `/Users/ahmed.rezk/.config/opencode/context/`, use ExternalScout.
...
| **Location** | `/Users/ahmed.rezk/.config/opencode/context/` | Internet (Context7, docs) |
