...
```bash
npx ts-node /Users/ahmed.rezk/.config/opencode/context/tasks/scripts/task-cli.ts <command> [args]
```
...
See `/Users/ahmed.rezk/.config/opencode/context/core/workflows/multi-stage-orchestration.md` for the complete workflow.
