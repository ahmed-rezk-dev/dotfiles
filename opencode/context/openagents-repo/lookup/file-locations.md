...
| **Context files** | `/Users/ahmed.rezk/.config/opencode/context/` |
...
| **New context** | `/Users/ahmed.rezk/.config/opencode/context/{category}/{name}.md` |
...
```
/Users/ahmed.rezk/.config/opencode/context/{category}/{topic}.md
```

**Examples**:
- `/Users/ahmed.rezk/.config/opencode/context/core/standards/code-quality.md`
- `/Users/ahmed.rezk/.config/opencode/context/ui/web/react-patterns.md`
- `/Users/ahmed.rezk/.config/opencode/context/content-creation/principles/copywriting-frameworks.md`
...
```bash
# By category
ls /Users/ahmed.rezk/.config/opencode/context/{category}/

# All context
find /Users/ahmed.rezk/.config/opencode/context -name "*.md"
```
