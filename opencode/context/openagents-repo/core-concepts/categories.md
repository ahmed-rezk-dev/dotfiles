...
/Users/ahmed.rezk/.config/opencode/context/development/
├── navigation.md
├── clean-code.md
├── react-patterns.md
└── api-design.md
...
mkdir -p /Users/ahmed.rezk/.config/opencode/context/{category}
...
```bash
cat > /Users/ahmed.rezk/.config/opencode/context/{category}/navigation.md << 'EOF'
...
```
/Users/ahmed.rezk/.config/opencode/context/{category}/
...
Loads: `/Users/ahmed.rezk/.config/opencode/context/ui/web/react-patterns.md`
