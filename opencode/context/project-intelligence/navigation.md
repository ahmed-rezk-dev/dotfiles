...
```
/Users/ahmed.rezk/.config/opencode/context/project-intelligence/
...
- `/Users/ahmed.rezk/.config/opencode/context/core/standards/project-intelligence.md` (standards and patterns)
- `/Users/ahmed.rezk/.config/opencode/context/core/system/context-guide.md` (context loading)

See `/Users/ahmed.rezk/.config/opencode/context/core/context-system.md` for the broader context architecture.
...
**Management Guide**: See `/Users/ahmed.rezk/.config/opencode/context/core/standards/project-intelligence-management.md` for complete lifecycle management including:
...
See `/Users/ahmed.rezk/.config/opencode/context/core/standards/project-intelligence.md` for the standard itself.
