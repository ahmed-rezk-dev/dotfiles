...
```bash
~/.config/opencode/skills/openscad/scripts/version-scad.sh <name>
```
...
```bash
~/.config/opencode/skills/preview-scad/scripts/render-scad.sh <name>_<version>.scad --output <name>_<version>.png
```
...
1. Check for existing versions:
   ```bash
   ~/.config/opencode/skills/openscad/scripts/version-scad.sh piano
   ```
...
3. Render preview:
   ```bash
   ~/.config/opencode/skills/preview-scad/scripts/render-scad.sh piano_001.scad --output piano_001.png
   ```
