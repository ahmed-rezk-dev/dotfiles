...
<workflow id="analyze_context_dependencies">
  <stage id="1" name="ScanAgents" required="true">
    ...
    **Search patterns**:
    - `/Users/ahmed.rezk/.config/opencode/context/` (direct path references)
    - `@/Users/ahmed.rezk/.config/opencode/context/` (@ symbol references)
  ...
  <stage id="3" name="ValidateContextFiles" required="true">
    ...
    **Check existence**:
    ```bash
    test -f /Users/ahmed.rezk/.config/opencode/context/core/standards/code-quality.md
    ```
  ...
  <stage id="4" name="Report" required="true">
    ...
    **Uses but not declared**:
    - context:core/standards/code (referenced 3 times)
      - Line 64: "Code tasks → /Users/ahmed.rezk/.config/opencode/context/core/standards/code-quality.md (MANDATORY)"
      - Line 170: "Read /Users/ahmed.rezk/.config/opencode/context/core/standards/code-quality.md NOW"
...
```bash
grep -rn "\/Users/ahmed.rezk/.config/opencode/context/" .opencode/agent/ .opencode/command/
```
...
- `/Users/ahmed.rezk/.config/opencode/context/core/standards/code-quality.md` → `context:core/standards/code`
- `@/Users/ahmed.rezk/.config/opencode/context/openagents-repo/quick-start.md` → `context:openagents-repo/quick-start`
...
task(
  ...
  prompt=`
    ...
    2. Search for these patterns:
       - "/Users/ahmed.rezk/.config/opencode/context/core/" (direct paths)
       - "@/Users/ahmed.rezk/.config/opencode/context/" (@ references)
    ...
    4. For each context file in /Users/ahmed.rezk/.config/opencode/context/core/:
...
✓ /Users/ahmed.rezk/.config/opencode/context/core/context-system.md (1 reference)
  - Line 15: "Load: context:core/context-system"
✓ /Users/ahmed.rezk/.config/opencode/context/core/context-system/standards/mvi.md (2 references)
...
- **Context guide**: `/Users/ahmed.rezk/.config/opencode/context/openagents-repo/quality/registry-dependencies.md`
