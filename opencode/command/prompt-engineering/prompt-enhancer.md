  ...
  <workflow_execution>
    ...
    <stage id="4" name="OptimizeInstructionRatio">
      ...
      <extraction_candidates>
        <session_management>Extract to context file (example: /Users/ahmed.rezk/.config/opencode/context/core/session-management.md)</session_management>
        <context_discovery>Extract to context file (example: /Users/ahmed.rezk/.config/opencode/context/core/context-discovery.md)</context_discovery>
        <detailed_examples>Extract to context file (example: /Users/ahmed.rezk/.config/opencode/context/core/examples.md)</detailed_examples>
        <implementation_specs>Extract to context file (example: /Users/ahmed.rezk/.config/opencode/context/core/specifications.md)</implementation_specs>
      </extraction_candidates>
    ...
    <stage id="10" name="DeliverOptimized">
      ...
      <output_format>
        ...
        **Improvement**: +Z points
        ...
        - `/Users/ahmed.rezk/.config/opencode/context/core/[name].md` - [description]
        ...
        **Required Context Files** (if any):
        - `/Users/ahmed.rezk/.config/opencode/context/core/[file].md`
...
<references>
  <optimization_report>
    Detailed before/after metrics from OpenAgent optimization (example: /Users/ahmed.rezk/.config/opencode/context/core/prompt-optimization-report.md)
  </optimization_report>
