...
- ✅ Flexible context discovery (.oac config, .claude/context, context, /Users/ahmed.rezk/.config/opencode/context)
...
**The OAC solution:** Store team patterns in `/Users/ahmed.rezk/.config/opencode/context/project/`. Commit to repo. Everyone uses same standards.
...
# Commit to repo
git add /Users/ahmed.rezk/.config/opencode/context/
...
Store patterns in `/Users/ahmed.rezk/.config/opencode/context/project/`. Commit to repo. Entire team uses same standards. New developers inherit patterns automatically.
...
```
1. Check local: /Users/ahmed.rezk/.config/opencode/context/core/navigation.md
...
- **Project intelligence is always local** — your tech stack, patterns, and naming conventions live in `/Users/ahmed.rezk/.config/opencode/context/project-intelligence/` and are never loaded from global
...
|-------|----------------|--------------------------|
| Local install (`bash install.sh developer`) | `/Users/ahmed.rezk/.config/opencode/context/core/` | `/Users/ahmed.rezk/.config/opencode/context/project-intelligence/` |
| Global install + `/add-context` | `~/.config/opencode/context/core/` | `/Users/ahmed.rezk/.config/opencode/context/project-intelligence/` |
| Both local and global | `/Users/ahmed.rezk/.config/opencode/context/core/` (local wins) | `/Users/ahmed.rezk/.config/opencode/context/project-intelligence/` |
...
A: Commit `/Users/ahmed.rezk/.config/opencode/context/project/` to your repo. Team members automatically use same patterns.
