...
```bash
~/.config/opencode/skills/export-stl/scripts/export-stl.sh <input.scad> [options]
```
...
```bash
~/.config/opencode/skills/export-stl/scripts/export-stl.sh phone_stand_003.scad
```
