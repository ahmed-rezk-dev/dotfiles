...
```bash
~/.config/opencode/skills/preview-scad/scripts/render-scad.sh <input.scad> [options]
```
...
```bash
~/.config/opencode/skills/preview-scad/scripts/render-scad.sh phone_stand.scad
```
