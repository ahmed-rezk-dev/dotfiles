...
local normal_mode_mappings = {
  ...
  g = {
    ...
    d =  {
      f = { '<cmd>lua require("plugins.git.diffview").toggle_file_history()<CR>', 'diff file' },
      h = { "<cmd>DiffviewFileHistory %<cr>", "File History / Current File" },
  ...
  p = {
    ...
    s = {
      ...
      l = { ":SessionRestore<cr>", "Load Session" },
      f = { "<cmd>lua require('nvim-possession').list()<cr>", "list" },
      g = { "<cmd>lua require('nvim-possession').new()<cr>", "new" },
      G = { "<cmd>lua require('nvim-possession').update()<cr>", "update" },
    },
  ...
  s = {
    ...
    D = {
      name = "Devdocs",
      f = { ":DevdocsFetch<cr>", "Devdocs Fetch" },
      i = { ":DevdocsInstall<cr>", "Devdocs Install" },
      r = { ":DevdocsUninstall<cr>", "Devdocs Unistall" },
      o = { ":DevdocsOpen<cr>", "Devdocs Open" },
      O = { ":DevdocsOpenFloat<cr>", "Devdocs Open Float" },
      c = { ":DevdocsOpenCurrent<cr>", "Devdocs Open Current" },
      C = { ":DevdocsOpenCurrentFloat<cr>", "Devdocs Open Current Float" },
      u = { ":DevdocsUpdate<cr>", "Devdocs Update" },
      U = { ":DevdocsUpdateAll<cr>", "Devdocs Update All" },
    },
  },
