return {
  ...
  { "<leader>dt", "<cmd>TroubleToggle<CR>", desc = "local diagnostics", nowait = true, remap = false },
  ...
  { "<leader>cd", group = "Database", nowait = true, remap = false },
  { "<leader>cdt", "<cmd>lua require('dbee').toggle()<CR>", desc = "Toggle", nowait = true, remap = false },
  { "<leader>cdo", "<cmd>lua require('dbee').close()<CR>", desc = "Close", nowait = true, remap = false },
  { "<leader>cdc", "<cmd>lua require('dbee').open()<CR>", desc = "Open", nowait = true, remap = false },
  { "<leader>cde", "<cmd>Dbee execute<CR>", desc = "execute", nowait = true, remap = false },
