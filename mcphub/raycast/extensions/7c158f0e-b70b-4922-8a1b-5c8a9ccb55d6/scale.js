...
`);return t?t.originalMessage=t.message:t=u,t.message=E,t.shortMessage=f,t.command=i,t.exitCode=s,t.signal=a,t.stdout=r,t.stderr=e,"bufferedData"in t&&delete t.bufferedData,t}function ze({stdout:r,stderr:e,error:t,exitCode:a,signal:s,timedOut:i,command:n,options:o,parentError:u}){if(t||a!==0||s!==null)throw Ve({error:t,exitCode:a,signal:s,stdout:r,stderr:e,command:n,timedOut:i,options:o,parentError:u});return r}async function $(r,e,t){if(process.platform!=="darwin")throw new Error("AppleScript is only supported on macOS");let{humanReadableOutput:a,language:s,timeout:i,...n}=Array.isArray(e)?t||{}:e||{},o=a!==!1?[]:["-ss"];s==="JavaScript"&&o.push("-l","JavaScript"),Array.isArray(e)&&o.push("-",...e);let u=se.default.spawn("osascript",o,{...n,env:{PATH:"/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin"}}),l=Ne(u,{timeout:i??1e4});u.stdin.end(r);let[{error:b,exitCode:f,signal:E,timedOut:M},k,R]=await We(u,{encoding:"utf8"},l),Ae=ne({stripFinalNewline:!0},k),Te=ne({stripFinalNewline:!0},R);return ze({stdout:Ae,stderr:Te,error:b,exitCode:f,signal:E,timedOut:M,command:"osascript",options:t,parentError:new Error})}var C=require("child_process"),m=require("@raycast/api");var le=require("fs");async function Be(){let r="";try{r=(0,C.execSync)(`/bin/zsh -lc 'realpath "$(which brew)"'`).toString().trim()}catch(e){console.error(e)}if(r==="")return await(0,m.showToast)({title:"Homebrew is required to install the AVIF encoder.",message:"Please install Homebrew and try again. Visit https://brew.sh for more information. Once Homebrew is installed, run the command `brew install libavif` to install the AVIF encoder manually (Otherwise, this command will be run automatically).",style:m.Toast.Style.Failure}),!1;if(await(0,m.confirmAlert)({title:"Install AVIF Encoder",message:"The libavif Homebrew formula is required to convert images to/from AVIF format. Would you like to install it now?",primaryAction:{title:"Install"}})){let e=await(0,m.showToast)({title:"Installing AVIF Encoder...",style:m.Toast.Style.Animated});try{if((0,C.execSync)(`/bin/zsh -ilc '${r} install --quiet libavif || true'`),!He())throw new Error("The avifenc binary has not been added to the user's $PATH");return e.title="AVIF Encoder installed successfully!",e.style=m.Toast.Style.Success,!0}catch(t){console.error(t),g("Failed to install AVIF Encoder.",t,e,"If you previously attempted to install libavif or avifenc, please run `brew doctor` followed by `brew cleanup` and try again.")}}return await(0,m.showToast)({title:"AVIF Encoder not installed.",style:m.Toast.Style.Failure}),!1}async function He(){let t=!1,a=0;for(;!t&&a<7;){let s=(0,C.execSync)("/bin/zsh -lc 'command -v avifenc'").toString().trim();if((0,le.existsSync)(s)){t=!0;break}await new Promise(i=>setTimeout(i,1e3)),a++}return t}async function J(){let r=await m.LocalStorage.getItem("avifEncoderPath"),e=await m.LocalStorage.getItem("avifDecoderPath");if(!r||!e)try{r=(0,C.execSync)(`/bin/zsh -lc 'realpath "$(which avifenc)"'`).toString().trim(),e=(0,C.execSync)(`/bin/zsh -lc 'realpath "$(which avifdec)"'`).toString().trim(),r&&await m.LocalStorage.setItem("avifEncoderPath",r),e&&await m.LocalStorage.setItem("avifDecoderPath",e)}catch(t){if(await Be())try{return await J()}catch(a){console.error(a),g("AVIF Encoder not found.",a,void 0,"Please install the libavif Homebrew formula manually and try again.")}else g("AVIF Encoder not found.",t,void 0,"Please install the libavif Homebrew formula and try again.")}if(typeof r!="string"||typeof e!="string")throw new Error("AVIF encoder and decoder paths could not be resolved.");return{encoderPath:r,decoderPath:e}}var ue=async()=>$(`use framework "AppKit"
      ...
      end if`)};var I=x(require("path"));var L=require("child_process");function P(r,e){let t=e?.command,a=e?.language,s=[...e?.leadingArgs?.map(f=>f.toString())||[]],i=e?.trailingArgs||[];!t&&(a===void 0||a==="AppleScript"||a==="JXA")&&(t="/usr/bin/osascript",s.push("-l",a==="JXA"?"JavaScript":"AppleScript",...r.startsWith("/")?[]:["-e"],r,...i.map(f=>f.toString())));let n=process.env;if(e?.command&&(n.PATH=`${n.PATH}:${(0,L.execSync)(`$(/bin/bash -lc 'echo $SHELL') -lc 'echo "$PATH"'`).toString()}`,t=e.command,s.push(r,...i.map(f=>f.toString()))),!t)throw new Error("No command specified.");let o="",u=f=>{console.log(f)},l=(0,L.spawn)(t,s,{env:n});return e?.logDebugMessages&&console.log(`Running shell command "${t} ${s.join(" ")}"`),l.stdout?.on("data",f=>{o+=f.toString(),e?.logIntermediateOutput&&console.log(`Data from script: ${o}`)}),l.stderr?.on("data",f=>{e?.stderrCallback&&e.stderrCallback(f.toString()),e?.logErrors&&console.error(f.toString())}),l.stdin.on("error",f=>{e?.logErrors&&console.error(`Error writing to stdin: ${f}`)}),u=async f=>{f?.length>0&&(l.stdin.cork(),l.stdin.write(`${f}\r
`),process.nextTick(()=>l.stdin.uncork()),e?.logSentMessages&&console.log(`Sent message: ${f}`))},{data:(async()=>new Promise((f,E)=>{let M=e?.timeout?setTimeout(()=>{try{l.kill()}catch(k){e?.logErrors&&console.error(`Error killing process: ${k}`)}return e?.logErrors&&console.error("Script timed out"),l.stdin.end(),l.kill(),E("Script timed out")},e?.timeout):void 0;l.on("close",k=>{if(k!==0)return e?.logErrors&&console.error(`Script exited with code ${k}`),l.stdin.end(),l.kill(),E(`Script exited with code ${k}`);clearTimeout(M);let R;try{R=JSON.parse(o)}catch{R=o.trim()}return e?.logFinalOutput&&console.log(`Script output: ${R}`),f(R)})}))(),sendMessage:u}}var A=require("@raycast/api");function S(r){return r.split(", /").map((e,t)=>t===0?e.trim():`/${e.trim()}`)}async function de(){let r=I.default.join(A.environment.assetsPath,"scripts","finder.scpt"),e=await P(r,{language:"AppleScript",stderrCallback:t=>g("Finder Selection Error",new Error(t))}).data;return Array.isArray(e)?e:S(e)}async function pe(){let r=I.default.join(A.environment.assetsPath,"scripts","houdahSpot.scpt"),e=await P(r,{language:"AppleScript",stderrCallback:t=>g("HoudahSpot Selection Error",new Error(t))}).data;return Array.isArray(e)?e:S(e)}async function he(){let r=I.default.join(A.environment.assetsPath,"scripts","neofinder.scpt"),e=await P(r,{language:"AppleScript",stderrCallback:t=>g("NeoFinder Selection Error",new Error(t))}).data;return Array.isArray(e)?e:S(e)}async function me(){let r=I.default.join(A.environment.assetsPath,"scripts","pathfinder.scpt"),e=await P(r,{language:"JXA",stderrCallback:t=>g("Path Finder Selection Error",new Error(t))}).data;return Array.isArray(e)?e:S(e)}async function ge(){let r=I.default.join(A.environment.assetsPath,"scripts","qspace.scpt"),e=await P(r,{language:"JXA",stderrCallback:t=>g("QSpace Pro Selection Error",new Error(t))}).data;return Array.isArray(e)?e:S(e)}async function be(){let r=I.default.join(A.environment.assetsPath,"scripts","forklift-beta.scpt"),e=await P(r,{language:"JXA",stderrCallback:t=>g("ForkLift Selection Error",new Error(t))}).data;return Array.isArray(e)?e:S(e)}var X=async(r,e)=>{let t=d.default.join(y.tmpdir(),`${r}.${e}`);return{path:t,[Symbol.asyncDispose]:async()=>{p.existsSync(t)&&await p.promises.rm(t,{recursive:!0})}}};var $e=async()=>{let e=(await c.LocalStorage.getItem("itemsToRemove")??"").toString().split(`
`).filter(Boolean);for(let t of e)p.existsSync(t)&&await p.promises.rm(t,{recursive:!0});await c.LocalStorage.removeItem("itemsToRemove")},we=async()=>{let r=[],t=(0,c.getPreferenceValues)().inputMethod,a=!1;if(t=="Clipboard")try{let n=S(await ue());if(await c.LocalStorage.setItem("itemsToRemove",n.join(`
`)),n.filter(o=>o.trim().length>0).length>0)return n}catch(n){console.error(`Couldn't get images from clipboard: ${n}`),a=!0}let s=t;try{s=(await(0,c.getFrontmostApplication)()).name}catch(n){console.error(`Couldn't get frontmost application: ${n}`)}try{(t=="Path Finder"||s=="Path Finder")&&(r=await me())}catch(n){console.error(`Couldn't get images from Path Finder: ${n}`),a=!0}try{(t=="NeoFinder"||s=="NeoFinder")&&(r=await he())}catch(n){console.error(`Couldn't get images from NeoFinder: ${n}`),a=!0}try{(t=="HoudahSpot"||s=="HoudahSpot")&&(r=await pe())}catch(n){console.error(`Couldn't get images from HoudahSpot: ${n}`),a=!0}try{(t=="QSpace"||s=="QSpace Pro"||s=="QSpace")&&(r=await ge())}catch(n){console.error(`Couldn't get images from ${s}: ${n}`),a=!0}try{(t=="ForkLift"||s=="ForkLift")&&(r=await be())}catch(n){console.error(`Couldn't get images from ForkLift: ${n}`),a=!0}if(r.length>0)return r.filter((n,o)=>r.indexOf(n)===o);let i=await de();return s=="Finder"||t=="Finder"||a?r=i:i.forEach(n=>{n.split("/").at(-2)=="Desktop"&&!r.includes(n)&&r.push(n)}),r.filter((n,o)=>r.indexOf(n)===o)},Se=async r=>{let e="Finder";try{e=(await(0,c.getFrontmostApplication)()).name}catch(a){console.error(`Couldn't get frontmost application: : ${a}`)}let t=(0,c.getPreferenceValues)();t.imageResultHandling=="copyToClipboard"?(await fe(r),ye(r)):t.imageResultHandling=="openInPreview"?(await Je(r),ye(r)):t.inputMethod=="NeoFinder"||e=="NeoFinder"?await(0,c.showInFinder)(r[0]):(t.inputMethod=="HoudahSpot"||e=="HoudahSpot")&&await(0,c.showInFinder)(r[0])},Ge=async()=>(y.cpus()[0].model.includes("Apple")?"arm":"x86")=="arm"?((0,w.execSync)(`chmod +x "${c.environment.assetsPath}/webp/arm/dwebp"`),(0,w.execSync)(`chmod +x "${c.environment.assetsPath}/webp/arm/cwebp"`),p.existsSync(`${c.environment.assetsPath}/webp/x86/dwebp`)&&await p.promises.rm(`${c.environment.assetsPath}/webp/x86/dwebp`),p.existsSync(`${c.environment.assetsPath}/webp/x86/cwebp`)&&await p.promises.rm(`${c.environment.assetsPath}/webp/x86/cwebp`),[`${c.environment.assetsPath}/webp/arm/dwebp`,`${c.environment.assetsPath}/webp/arm/cwebp`]):((0,w.execSync)(`chmod +x "${c.environment.assetsPath}/webp/x86/dwebp"`),(0,w.execSync)(`chmod +x "${c.environment.assetsPath}/webp/x86/cwebp"`),p.existsSync(`${c.environment.assetsPath}/webp/arm/dwebp`)&&await p.promises.rm(`${c.environment.assetsPath}/webp/arm/dwebp`),p.existsSync(`${c.environment.assetsPath}/webp/arm/cwebp`)&&await p.promises.rm(`${c.environment.assetsPath}/webp/arm/cwebp`),[`${c.environment.assetsPath}/webp/x86/dwebp`,`${c.environment.assetsPath}/webp/x86/cwebp`]),ke=async(r,e)=>{var o=[];try{let t=(0,c.getPreferenceValues)();let a=O(o,await X("tmp","png"),!0);let s=(await D([e]))[0];let[i,n]=await Ge();(0,w.execSync)(`"${i}" "${e}" -o "${a.path}" && ${r} "${a.path}" && "${n}" ${t.useLosslessConversion?"-lossless":""} "${a.path}" -o "${s}"`);return s}catch(u){var l=u,b=!0}finally{var f=_(o,l,b);f&&await f}},xe=async(r,e)=>{var o=[];try{let t=(0,c.getPreferenceValues)();let a=O(o,await X("tmp","png"),!0);let s=(await D([e]))[0];let{encoderPath:i,decoderPath:n}=await J();(0,w.execSync)(`"${n}" "${e}" "${a.path}" && ${r} "${a.path}" && "${i}" ${t.useLosslessConversion?"-s 0 --min 0 --max 0 --minalpha 0 --maxalpha 0 --qcolor 100 --qalpha 100":""}  "${a.path}" "${s}"`);return s}catch(u){var l=u,b=!0}finally{var f=_(o,l,b);f&&await f}},ve=async(r,e)=>{var s=[];try{let t=O(s,await X("tmp","bmp"),!0);let a=(await D([e]))[0];await Ke("BMP",e,t.path);(0,w.execSync)(`chmod +x "${c.environment.assetsPath}/potrace/potrace"`);(0,w.execSync)(`${r} "${t.path}" && "${c.environment.assetsPath}/potrace/potrace" -s --tight -o "${a}" "${t.path}"`);return a}catch(i){var n=i,o=!0}finally{var u=_(s,n,o);u&&await u}},Ke=async(r,e,t)=>$(`use framework "Foundation"
  use scripting additions
